          ...
          GestureDetector(
            onTap: () {
              switch (Screen) {
                case 'GENDERSCREEN':
                  {
                    context.read<Providers>().setGender = gender;
                  }
                  break;
                case 'AGESCREEN':
                  {
                    context.read<Providers>().setAge = age;
                  }
                  break;
                case 'HEIGHTSCREEN':
                  {
                    context.read<Providers>().setHeight = height;
                  }
                  break;
                case 'WEIGHTSCREEN':
                  {
                    context.read<Providers>().setWeight = weight;
                  }
                  break;
                case 'CALORIESCREEN':
                  {
