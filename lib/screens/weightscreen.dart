    ...
    return Scaffold(
      body: Column(
        ...
        children: [
           ...
           const Text("WHAT'S YOUR WEIGHT?", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w900, fontFamily: 'IntegralCF'),),
           ...
           InfoSelectionBottom(Screen: "WEIGHTSCREEN", nextScreen: const HeightSelectorScreen(), weight: weight,)
        ],
      ),
    );
  }
