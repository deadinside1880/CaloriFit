      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(p1, style: const TextStyle(color: Color(0xFFB5B5B5), fontSize: 18),),
            const SizedBox(height: 20,),
            Text(p2, style: const TextStyle(color: Color(0xFFB5B5B5), fontSize: 18),),
            const SizedBox(height: 20,),
            Text(p3, style: const TextStyle(color: Color(0xFFB5B5B5), fontSize: 18),),
          ],
        ),
      ),
    );
